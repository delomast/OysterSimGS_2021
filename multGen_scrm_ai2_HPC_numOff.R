...
numOffspringArg <- as.numeric(cmdArgs[4])
...
nOffspringPerCross <- numOffspringArg
nGenerations <- 3
...
# for low memory use
save(imputeRes, gebvRes, He_res, file = paste0("rda/multGen_scrm_small_numOff", nOffspringPerCross, "_", iterationNumber, ".rda"))
