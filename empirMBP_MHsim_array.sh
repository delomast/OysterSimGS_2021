...
#SBATCH --array=71%75 #specify how many jobs in the array and limit number running concurrently (e.g. 1-96%40)
...
Rscript mh_empir_HPC.R $x $SLURM_ARRAY_TASK_ID /90daydata/oyster_gs_sim/ ../seq_data/mbp_simInput.vcf 
